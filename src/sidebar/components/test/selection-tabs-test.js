...
describe('selectionTabs', function () {
  ...
  context('displays selection tabs, counts and a selection', function () {
    it('should display the tabs and counts of annotations and notes when the theme is not custom', function () {
    ...
    it('should display notes tab as selected when the theme is not custom', function () {
      if (fakeSettings.theme !== 'custom'){
        var elem = util.createDirective(document, 'selectionTabs', {
          selectedTab: 'note',
          totalAnnotations: '123',
    ...
    it('should display the longer version of the no notes message when there are no notes and the theme is not custom', function () {
      if(fakeSettings.theme !== 'custom'){
    ...
    context('when the sidebar tutorial is displayed', function () {
      ...
      it('should display the shorter version of the no notes message when there are no notes and the theme is not custom', function () {
        if(fakeSettings.theme !== 'custom'){
          var elem = util.createDirective(document, 'selectionTabs', {
            selectedTab: 'note',
            totalAnnotations: '10',
