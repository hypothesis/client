...
describe('DrawToolAnnouncer', () => {
  ...
  describe('point tool', () => {
    it('announces pin position when mode is move and x,y provided', () => {
      ...
      const content = wrapper
        .find('[data-testid="draw-tool-announcer"]')
        .text();
    ...
    it('announces arrow keys message when mode is resize (pin)', () => {
      const wrapper = mount(
        <DrawToolAnnouncer tool="point" mode="resize" keyboardActive={true} />,
      );
      const content = wrapper
        .find('[data-testid="draw-tool-announcer"]')
        .text();
    ...
    it('announces Enter to confirm when mode is rect or default', () => {
      const wrapper = mount(
        <DrawToolAnnouncer tool="point" mode="rect" keyboardActive={true} />,
      );
      const content = wrapper
        .find('[data-testid="draw-tool-announcer"]')
        .text();
  ...
  describe('rect tool', () => {
    ...
    it('announces rectangle mode message when mode is rect', () => {
      const wrapper = mount(
        <DrawToolAnnouncer tool="rect" mode="rect" keyboardActive={true} />,
      );
      const content = wrapper
        .find('[data-testid="draw-tool-announcer"]')
        .text();
      ...
      assert.include(
        content,
        'Click the mode button to switch to Move or Resize',
      );
    });
