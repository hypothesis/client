...
describe('annotator/anchoring/pdf', () => {
  ...
  describe('describeShape', () => {
    ...
    beforeEach(() => {
      // Dummy element uto check that elements returned by `elementsFromPoint`,
    ...
    context('when shape is a rect', () => {
      ...
      it('returns selectors with PDF user space coordinates for rect', async () => {
        const pageView = viewer.pdfViewer.getPageView(0);
        const expectedTopLeft = pageView.getPagePoint(10, 10);
        const expectedBottomRight = pageView.getPagePoint(30, 50);
        ...
        assert.deepEqual(selectors, [
          ...
          },
          {
            ...
            shape: {
              type: 'rect',
              left: expectedTopLeft[0],
              top: expectedTopLeft[1],
              right: expectedBottomRight[0],
              bottom: expectedBottomRight[1],
            },
          },
        ]);
      });
